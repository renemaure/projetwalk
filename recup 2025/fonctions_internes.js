...
/* function actionRadio(drapeau) {
           ...
           console.log("bouton actif")
            for (const radioButton of radioButtons) {
                if (radioButton.checked) {
					...
					console.log("retour trapeau" + drapeau) 
					break
            	}
            }
            // show the output:
		...
		console.log("test sorti boucle")
	return drapeau
} */

	function actionRadio(callback) {
    	const btn = document.querySelector('#btn');        
    	const radioButtons = document.querySelectorAll('input[name="avt_valid"]');
	    btn.addEventListener("click", () => {
       		let drapeau = null;
        ...
        callback(drapeau);   // 👉 on renvoie la valeur ici
    });
}
