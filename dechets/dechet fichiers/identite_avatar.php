...
<p class="t65 l20"><span class="gras">Tirage : </span>  <?php echo(($lireinfo[2]>1) ? ("effectué") : ("non effectué")); ?> </p>

<p class="t75 l20"><span class="gras">Image avatar : </span>  <?php echo(($lireinfo[2]>2) ? ("effectué") : ("non effectué"));  ?> </p>

	<div id ="img_avatar">
		<?php if($lireinfo[2]==2){  ?> 
	
		<p class="t10  f12 centrer"><a href="index.php?util=fichiers/dessin&cod=2">définissez<br> l'apparence <br>de votre <br>avatar</a> <?php echo($lireinfo[2]); ?> </p>
		<?php ; 
		} 
